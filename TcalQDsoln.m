...
% Estimate
[tout,cout] = ode23s(@TcalQD,[0 96],[40; 0; 0; 0; 0;0;0]);
[tout2,cout2] = ode23s(@TcalQD,[0 10],[40; 0; 0; 0; 0;0;0]);

figure(1)
plot(tout,cout,'LineWidth',2)
axis([0 96 0 40])
title('Concentration of CalQDs in Various Organs over 4 days (in nM)')
xlabel('Time (hours)')
...
title('CalQD Concentration in Tissues After 10 Hours (Tumor)')
xlabel('Time (hours)')
ylabel('Concentration (nM)')
