...
%Volume parameters, V (mL)--based on research DON'T CHANGE THESE
vp = 1.078; % blood
vk = 0.3674; % kidney
vli = 1.2078; % liver
vs = 0.077; % spleen
...
% Volumetric Flow parameters, Q (mL/h)--based on research DON'T CHANGE
% THESE
qk = 85.7714; % kidney
qli = 132.8985; % liver
qs = 18.8509; % spleen
...
% Partition Coefficients, R (unitless)--CHANGE THESE SO HARD
rk = 38; % kidney
rli = 65; % liver
rs = 35; % spleen
rl = 20; % lungs
...
% Drug removal CAN CHANGE THIS A BIT
