function TconQDsoln2x

% Plot estimates vs actual data
% Estimate
[tout,cout] = ode23s(@TconQD2x,[0 96],[40; 0; 0; 0; 0;0;0]);
[tout2,cout2] = ode23s(@TconQD2x,[0 10],[40; 0; 0; 0; 0;0;0]);

figure(1)
plot(tout,cout,'LineWidth',2)
axis([0 96 0 40])
title('Concentration of ConQDs in Organs (ETumor)')
xlabel('Time (hours)')
...
title('ConQD Concentration in Tissues After 10 Hours (ETumor)')
xlabel('Time (hours)')
ylabel('Concentration (nM)')
%cout
cout(end,:)
