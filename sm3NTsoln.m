...
% Estimate
[tout,cout] = ode23s(@sm3QDnoTumor,[0 96],[40; 0; 0; 0; 0;0]);
[tout2,cout2] = ode23s(@sm3QDnoTumor,[0 2],[40; 0; 0; 0; 0;0]);

figure(1)
plot(tout,cout,'LineWidth',2)
axis([0 96 0 40])
title('SM3QD Concentration in Tissues After 4 Days (in nM)')
xlabel('Time (hours)')
...
title('SM3QD Concentration in Tissues After 2 Hours (in nM)')
xlabel('Time (hours)')
ylabel('Concentration (nM)')
legend('C_p_l_a_s_m_a','C_k_i_d_n_e_y','C_l_i_v_e_r','C_s_p_l_e_e_n','C_l_u_n_g','C_o_t_h_e_r','Location','northeast')
%cout
