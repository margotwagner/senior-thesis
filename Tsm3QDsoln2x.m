function Tsm3QDsoln2x

% Plot estimates vs actual data
% Estimate
[tout,cout] = ode23s(@Tsm3QD2x,[0 96],[40; 0; 0; 0; 0;0;0]);
[tout2,cout2] = ode23s(@Tsm3QD2x,[0 10],[40; 0; 0; 0; 0;0;0]);

figure(1)
plot(tout,cout,'LineWidth',2)
axis([0 96 0 40])
title('Concentration of SM3QDs in Organs (ETumor)')
xlabel('Time (hours)')
...
title('SM3QD Concentration in Tissues After 10 Hours (ETumor)')
xlabel('Time (hours)')
ylabel('Concentration (nM)')
